...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($_GET['id']) ? "Update " : "Tambah data " ?>tanggapan dan respon</h3>
	</div>
	<div class="card-body">
		<form action="" id="response-form">
			...
			<?php if (!isset($id)) : ?>
				<div class="form-group">
					<label for="question_field" class="control-label">Tanggapan</label>
					...
					<small><i>(Klik "<b>+</b>" untuk tambah tanggapan)</i></small>
				</div>
			<?php else : ?>
				<div class="form-group">
					<label for="question_field" class="control-label">Tanggapan</label>
			...
			<div class="form-group">
				<label for="response_message" class="control-label">Respon jawaban</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="response-form">Simpan</button>

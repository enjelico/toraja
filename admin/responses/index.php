...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Daftar tanggapan dan respon</h3>
		<div class="card-tools">
			<a href="?page=responses/manage" class="btn btn-flat btn-info"><span class="fas fa-plus"></span> Tambah Data</a>
		</div>
	</div>
	<div class="card-body">

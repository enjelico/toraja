...
<aside class="main-sidebar sidebar-dark-primary elevation-4 bg-info text-white">
  ...
  <a href="<?php echo base_url ?>admin" class="brand-link bg-info text-sm">
    <img src="<?php echo validate_image($_settings->info('logo')) ?>" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8;width: 2.5rem;height: 2.5rem;max-height: unset">
